...
//!
//! ```text
//! SYRINX_MODEL_DIR=... ORT_DYLIB_PATH=/usr/lib/libonnxruntime.so \
//!   cargo run -p syrinx-server --features cuda --example gpu_probe [cpu]
//! ```
...
fn main() -> anyhow::Result<()> {
    ...
    let dir = std::env::var("SYRINX_MODEL_DIR").expect("set SYRINX_MODEL_DIR");
